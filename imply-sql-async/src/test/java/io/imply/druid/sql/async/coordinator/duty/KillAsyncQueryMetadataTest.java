...
public class KillAsyncQueryMetadataTest
{
  ...
  {
    SqlAsyncQueryDetails sqlAsyncQueryDetails = SqlAsyncQueryDetails.createNew("asyncResultId1", IDENTITY, RESULT_FORMAT);
  ...
  public void testIsQueryEligibleForCleanupForRetainTime()
  {
    ...
    Assert.assertFalse(KillAsyncQueryMetadata.isQueryEligibleForCleanup(sqlAsyncQueryDetails, System.currentTimeMillis(), 100000));
  }
  ...
  public void testRun() throws Exception
  {
    ...
    SqlAsyncQueryDetails sqlAsyncQueryDetail1 = SqlAsyncQueryDetails.createNew(query1, IDENTITY, RESULT_FORMAT).toComplete(100);
    SqlAsyncQueryMetadata metadata1 = new SqlAsyncQueryMetadata(0);
    SqlAsyncQueryDetailsAndMetadata sqlAsyncQueryDetailAndStat1 = new SqlAsyncQueryDetailsAndMetadata(sqlAsyncQueryDetail1, metadata1);
    ...
    SqlAsyncQueryDetailsAndMetadata sqlAsyncQueryDetailAndStat2 = new SqlAsyncQueryDetailsAndMetadata(sqlAsyncQueryDetail2, metadata2);
    ...
    SqlAsyncQueryDetails sqlAsyncQueryDetail4 = SqlAsyncQueryDetails.createNew(query4, IDENTITY, RESULT_FORMAT).toComplete(100);
    SqlAsyncQueryMetadata metadata4 = new SqlAsyncQueryMetadata(System.currentTimeMillis());
    SqlAsyncQueryDetailsAndMetadata sqlAsyncQueryDetailAndStat4 = new SqlAsyncQueryDetailsAndMetadata(sqlAsyncQueryDetail4, metadata4);
    ...
    Mockito.when(mockSqlAsyncMetadataManager.getQueryDetailsAndMetadata(ArgumentMatchers.eq(query1))).thenReturn(Optional.of(sqlAsyncQueryDetailAndStat1));
    Mockito.when(mockSqlAsyncMetadataManager.getQueryDetailsAndMetadata(ArgumentMatchers.eq(query2))).thenReturn(Optional.of(sqlAsyncQueryDetailAndStat2));
    Mockito.when(mockSqlAsyncMetadataManager.getQueryDetailsAndMetadata(ArgumentMatchers.eq(query3))).thenReturn(Optional.empty());
    Mockito.when(mockSqlAsyncMetadataManager.getQueryDetailsAndMetadata(ArgumentMatchers.eq(query4))).thenReturn(Optional.of(sqlAsyncQueryDetailAndStat4));
