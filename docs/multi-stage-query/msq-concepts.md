...
|  ColumnNameRestricted|  The query contains usage of restricted column names that are required by MSQ to function  |    |
|  ColumnTypeNotSupported|  Support for writing or reading from a particular column type is unavailable |    |
