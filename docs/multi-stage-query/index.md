...
| talariaMode| (SELECT or INSERT)<br /><br />Execute a query with a predefined set of parameters which are pretuned. It can be set to `strict` or `nonStrict`. Please check the [Talaria Modes](#modes) section for more information.<br /><br />| strict |
