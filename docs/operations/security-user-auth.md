...
* EXTERNAL &ndash; External data read through the [EXTERN function](../multi-stage-query/msq-queries.md#read-external-data) in SQL.
...
the [EXTERN function](../multi-stage-query/msq-queries.md#read-external-data) in SQL
...
Queries to access external data through the [EXTERN function](../multi-stage-query/msq-queries.md#read-external-data) require EXTERNAL READ permissions.
