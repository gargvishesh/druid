...
import { SimpleCounter } from '../../../../workbench-models';

import './execution-stage-detail-pane.scss';

const formatRows = formatInteger;
const formatSize = (bytes: number) => `(${formatBytes(bytes)})`;
const formatFrames = formatInteger;

interface ExecutionStageDetailPaneProps {
  title: string;
  labelPrefix: string;
...
export function ExecutionStageDetailPane(props: ExecutionStageDetailPaneProps) {
