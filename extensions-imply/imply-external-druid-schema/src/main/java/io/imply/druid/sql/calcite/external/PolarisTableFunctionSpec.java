...
@JsonSubTypes(value = {
    ...
    @JsonSubTypes.Type(name = PolarisS3ConnectionInputSourceDefn.PolarisS3ConnectionFunctionSpec.FUNCTION_NAME, value = PolarisS3ConnectionInputSourceDefn.PolarisS3ConnectionFunctionSpec.class)
})
