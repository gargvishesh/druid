...
public class TalariaWarningReportBatcherPublisher implements TalariaWarningReportPublisher
{
  @GuardedBy("lock")
  ...
  public TalariaWarningReportBatcherPublisher(
