...
public class IndexerWorkerContext implements WorkerContext
{
   ...
   */
  @Override
  public synchronized TalariaTaskClient makeTaskClient(String id)
  {
    if (taskClient == null) {
  ...
  {
    return new IndexerFrameContext(this);
  }

  @Override
  public int threadCount()
  {
    return injector.getInstance(DruidProcessingConfig.class).getNumThreads();
  }
