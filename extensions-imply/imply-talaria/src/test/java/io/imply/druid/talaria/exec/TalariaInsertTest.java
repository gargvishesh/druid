...
public class TalariaInsertTest extends TalariaTestRunner
{
  ...
  @Test
  public void testInsertOnFoo1WithRollup()
  {
    RowSignature rowSignature = RowSignature.builder()
                                            .add("__time", ColumnType.LONG)
                                            .add("dim1", ColumnType.STRING)
    ...
    testInsertQuery().setSql(
                     ...
                     .setExpectedRowSignature(rowSignature)
                     .setExpectedResultRows(expectedFooRowsWithAggregatedColumn())
                     .verifyResults();

  }

  @Test
  public void testInsertOnFoo1WithTimeFunctionAndRollup()
  {
    RowSignature rowSignature = RowSignature.builder()
                                            .add("__time", ColumnType.LONG)
                                            .add("dim1", ColumnType.STRING)
  ...
  @Test
  public void testInsertOnFoo1WithTimeFunctionComplexColAndRollup()
  {
    RowSignature rowSignature = RowSignature.builder()
                                            .add("__time", ColumnType.LONG)
                                            .add("dim1", ColumnType.STRING)
  ...
  @Test
  public void testInsertOnFoo1ComplexColAndRollup()
  {
    RowSignature rowSignature = RowSignature.builder()
                                            .add("__time", ColumnType.LONG)
                                            .add("dim1", ColumnType.STRING)
  ...
  public void testRollupOnExternalDataSourceWithCompositeKey()
  {
    ...
    testInsertQuery().setSql(" insert into foo1 SELECT\n"
                     ...
                     .setExpectedResultRows(ImmutableList.of(
                         new Object[]{1466985600000L, "Benutzer Diskussion", 2L, 0L},
                         new Object[]{1466985600000L, "File", 1L, 0L},
                         new Object[]{1466985600000L, "Kategoria", 1L, 0L},
                         new Object[]{1466985600000L, "Main", 14L, 0L},
                         new Object[]{1466985600000L, "Wikipedia", 1L, 0L},
                         new Object[]{1466985600000L, "Википедия", 1L, 0L}
                     ))
                     .verifyResults();
  ...
  @Nonnull
  private List<Object[]> expectedFooRowsWithAggregatedColumn()
  {
    List<Object[]> expectedRows = new ArrayList<>();
    if (!useDefault) {
      expectedRows.add(new Object[]{946684800000L, "", 1L, 0L});
    }
    expectedRows.addAll(ImmutableList.of(
        new Object[]{946771200000L, "10.1", 1L, 0L},
        new Object[]{946857600000L, "2", 1L, 0L},
        new Object[]{978307200000L, "1", 1L, 0L},
        new Object[]{978393600000L, "def", 1L, 0L},
        new Object[]{978480000000L, "abc", 1L, 0L}
    ));
    return expectedRows;
  }
