...
To enable async query downloads, add `imply-sql-async` to the extensions load list.
...
Additionally, you need to add the following properties in `common.runtime.properties`.
