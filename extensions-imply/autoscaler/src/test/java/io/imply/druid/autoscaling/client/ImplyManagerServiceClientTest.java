...
public class ImplyManagerServiceClientTest
{
  ...
  private ImplyEnvironmentConfig implyEnvironmentConfig;
  ...
  public void setUp()
  {
    ...
    implyEnvironmentConfig = new ImplyEnvironmentConfig(IMPLY_MANAGER_ADDRESS, CLUSTER_ID);
  }
  ...
  public void testProvisionInstances() throws Exception
  {
    ...
    List<String> actual = implyManagerServiceClient.provisionInstances(implyEnvironmentConfig, workerVersion, numberToCreate);
  ...
  public void testTerminateInstances() throws Exception
  {
    ...
    implyManagerServiceClient.terminateInstances(implyEnvironmentConfig, instanceIdToTerminate);
  ...
  public void testListInstances() throws Exception
  {
    ...
    List<Instance> actual = implyManagerServiceClient.listInstances(implyEnvironmentConfig);
