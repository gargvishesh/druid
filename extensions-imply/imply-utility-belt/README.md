...
| `IP_COMPARE(expr1, expr2)` | Compares two IP addresses, `expr1` and `expr2`. Returns zero if they are equal, a negative number if `expr1` is lower than `expr2`, and a positive number if `expr2` is lower than `expr1`.|
