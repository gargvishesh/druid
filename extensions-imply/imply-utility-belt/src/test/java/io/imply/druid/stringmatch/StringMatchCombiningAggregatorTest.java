...
public class StringMatchCombiningAggregatorTest extends BaseStringMatchCombiningAggregatorTest
{
  @Override
  protected SerializablePairLongString aggregate(SerializablePairLongString... values)
  {
    ...
    final Aggregator aggregator = new StringMatchCombiningAggregator(
        selector,
