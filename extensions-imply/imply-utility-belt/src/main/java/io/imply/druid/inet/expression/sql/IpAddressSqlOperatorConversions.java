...
package io.imply.druid.inet.expression.sql;
...
public class IpAddressSqlOperatorConversions
{
  public static class ParseOperatorConversion implements SqlOperatorConversion
  {
    private static final SqlFunction SQL_FUNCTION = OperatorConversions
        ...
        .returnTypeInference(ReturnTypes.explicit(new RowSignatures.ComplexSqlType(SqlTypeName.OTHER, IpAddressModule.TYPE, true)))
  ...
  public static class StringifyOperatorConversion implements SqlOperatorConversion
  {
    ...
    )
    {
      return OperatorConversions.convertCall(
          ...
          rexNode,
          operands -> DruidExpression.fromExpression(
              DruidExpression.functionCall(IpAddressExpressions.StringifyExprMacro.NAME, operands)
          )
      );
    }
  }
