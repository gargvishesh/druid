...
public class BytesReadWriteTestCases
{
  ...
  public BytesReadWriteTestCases setReadWriteTestCaseValue(TestMethodHandle testMethodHandle, int expectedSize)
  {
  ...
  public BytesReadWriteTestCases setReadWriteTestCaseValue(
  ...
  public BytesReadWriteTestCases enableTestCase(MethodAccess<BytesReadWriteTest, Exception> methodAccess)
  {
    TestMethodHandle testMethodHandle = capture(methodAccess);
