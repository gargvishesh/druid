...
public abstract class DownsampledSumTimeSeriesBaseTest
{
  ...
  public void testMeanTS()
  {
    ...
    SimpleTimeSeries timeSeries = timeseriesBuilder(
        new SimpleTimeSeries[]{input},
        VISIBLE_WINDOW,
  ...
  public void testMergeTSWithDataPointsAndTimeseries()
  {
    ...
    SimpleTimeSeries timeSeries = timeseriesBuilder(
        new SimpleTimeSeries[]{input1, input2},
        VISIBLE_WINDOW,
        new DurationGranularity(2, 0)
    );
  ...
  public void testMergeTSWithTimeseries()
  {
    ...
    SimpleTimeSeries timeSeries = timeseriesBuilder(
        new SimpleTimeSeries[]{first, second, third},
        VISIBLE_WINDOW,
        new DurationGranularity(2, 0)
    );
  ...
  public void testMergeTSWithTimeserieswindow()
  {
    ...
    SimpleTimeSeries first = new SimpleTimeSeries(
        new ImplyLongArrayList(new long[]{2}),
    ...
    SimpleTimeSeries second = new SimpleTimeSeries(
        new ImplyLongArrayList(new long[]{2, 4}),
        new ImplyDoubleArrayList(new double[]{2, 5}),
        window,
        MAX_ENTRIES
    );
    SimpleTimeSeries third = new SimpleTimeSeries(
        new ImplyLongArrayList(new long[]{4}),
    ...
    SimpleTimeSeries expectedSeries = new SimpleTimeSeries(
        new ImplyLongArrayList(new long[]{2, 4}),
        new ImplyDoubleArrayList(new double[]{6, 15}),
        window,
        new TimeSeries.EdgePoint(0L, 3D),
        new TimeSeries.EdgePoint(6L, 15D),
        MAX_ENTRIES,
