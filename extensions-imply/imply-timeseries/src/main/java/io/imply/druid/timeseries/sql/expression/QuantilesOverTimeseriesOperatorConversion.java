...
public class QuantilesOverTimeseriesOperatorConversion implements SqlOperatorConversion
{
  private static final String NAME = QuantileOverTimeseriesExprMacro.NAME;
  ...
  public SqlOperator calciteOperator()
  {
    return OperatorConversions
        ...
        .operandTypeChecker(OperandTypes.sequence(
